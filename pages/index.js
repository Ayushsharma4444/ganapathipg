          ...
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <div className="block-two text-center">
                ...
                Ganapathi Nivas PG is an excellent choice for anyone looking for a comfortable and affordable stay..
                </div>
            ...
            >
              ...
              <SwiperSlide className="col-lg-12 block-eight text-center">
                ...
                <div className="inner-box">
                  ...
                  <div className="content">
                    <div className="text">
                    I recently stayed at Ganapathi Nivas PG and was quite disappointed with my experience.
